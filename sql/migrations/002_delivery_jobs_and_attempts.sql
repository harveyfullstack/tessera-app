...
-- Run inside a transaction (see schema-post-migration.sql). Duplicate intents are
-- archived before the uniqueness index is created. The attempts FK uses RESTRICT
-- so deleting a delivery_jobs row cannot take history with it.
